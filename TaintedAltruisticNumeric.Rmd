...
## Create DV-composite score(average of  questions 1-3 not including 5) for each participant
```{r,warning = FALSE, message = FALSE}
...
```
## Calculate the Cronbach's alpha for the survey questions that are planned  to be formed to be a composite score
```{r,warning = FALSE, message = FALSE}

Data1<- Data_attention_check_passed %>% select(c(Questions..1C_1,Questions..1C_2,Questions..1C_3))


install.packages("ltm")
library(ltm)
cronbach.alpha(Data1)
